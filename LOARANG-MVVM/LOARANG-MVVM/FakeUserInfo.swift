...
struct fakeUser {
    let user1 = UserInfo(basicInfo: BasicInfo(server: "니나브",
                                             name: "최지근",
                                             battleLV: "60",
                                             itemLV: "1506.67",
                                             expeditionLV: "119",
    ...
    let user2 = UserInfo(basicInfo: BasicInfo(server: "니나브",
                                             name: "권두기",
                                             battleLV: "60",
                                             itemLV: "1506.67",
                                             expeditionLV: "119",
    ...
    let user3 = UserInfo(basicInfo: BasicInfo(server: "니나브",
                                             name: "JJODAENG",
                                             battleLV: "60",
                                             itemLV: "1506.67",
                                             expeditionLV: "119",
                                             title: "넌 나의 션샤인인데 모 어쩌라고",
                                             guild: "미지근이라고하고긴이름길드",
                                             pvp: "20급",
                                             wisdom: "Lv.39 미지근지근지두기",
                                             class: "데모닉",
                                             userImageURL: "null"),
                        stat: Stat(basicEffect: BasicEffect(attack: "30000",
                                                            vitality: "30000",
